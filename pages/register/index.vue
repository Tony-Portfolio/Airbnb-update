            ...
            <section class="w-full h-full">
                <div class="grid grid-cols-1 sm:grid-cols-2 w-full h-full">
                    <div
                        ...
                        <p class="sm:text-black/[0.8] text-sm text-center text-white">Sudah punya akun? <NuxtLink
                        ...
                        <div class="flex flex-col justify-center gap-4">
                            ...
                            <div class="">
                                <label for="telp" class="text-left font-bold text-sm mb-2 block w-fit">Nomor Telepon</label>
                                <input type="text" placeholder="Nomor telepon anda"
                                    class="border-2 border-slate-800/[0.2] p-3 px-4 w-full rounded text-sm font-bold text-black"
                                    id="telp" name="telp" v-model="telp">
                            </div>
                            <div class="">
...
export default {
    ...
    methods: {
        setDataUser() {
            if (this.username == "" || this.password == "" || this.telp == "") {
